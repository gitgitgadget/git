...
test_expect_success 'git branch -c d e should work' '
	...
	test_when_finished test_unconfig branch.e.dummy &&
	git branch -c d e &&
	git reflog exists refs/heads/d &&
...
test_expect_success 'git branch --copy is a synonym for -c' '
	...
	test_when_finished test_unconfig branch.copy-to.dummy &&
...
test_expect_success 'git branch -c ee ef should copy ee to create branch ef' '
	...
	test_when_finished test_unconfig branch.ef.dummy &&
	git branch -c ee ef &&
	git reflog exists refs/heads/ee &&
...
test_expect_success 'git branch -c f/f g/g should work' '
	...
	test_when_finished test_unconfig branch.g/g.dummy &&
