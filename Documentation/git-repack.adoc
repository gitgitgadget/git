...
<<<<<<< HEAD:Documentation/git-repack.adoc
--name-hash-version=<n>::
	Provide this argument to the underlying `git pack-objects` process.
	See linkgit:git-pack-objects[1] for full details.

||||||| parent of 8d15862137 (repack: add --path-walk option):Documentation/git-repack.txt
=======
--path-walk::
	...
	or `--filter`.
>>>>>>> 8d15862137 (repack: add --path-walk option):Documentation/git-repack.txt
